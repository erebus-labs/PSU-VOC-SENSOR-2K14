...
#define ADC_IRQ_INTC_VECTOR            ((reg16 *) ADC_IRQ__INTC_VECT)

/* Address of the ADC_IRQ ISR priority. */
#define ADC_IRQ_INTC_PRIOR             ((reg8 *) ADC_IRQ__INTC_PRIOR_REG)
...
#define ADC_IRQ_INTC_SET_EN            ((reg8 *) ADC_IRQ__INTC_SET_EN_REG)

/* Address of the INTC.CLR_EN[x] register to bit clear the ADC_IRQ interrupt. */
#define ADC_IRQ_INTC_CLR_EN            ((reg8 *) ADC_IRQ__INTC_CLR_EN_REG)

/* Address of the INTC.SET_PD[x] register to set the ADC_IRQ interrupt state to pending. */
#define ADC_IRQ_INTC_SET_PD            ((reg8 *) ADC_IRQ__INTC_SET_PD_REG)

/* Address of the INTC.CLR_PD[x] register to clear the ADC_IRQ interrupt. */
#define ADC_IRQ_INTC_CLR_PD            ((reg8 *) ADC_IRQ__INTC_CLR_PD_REG)
