...
static uint8 ADC_MUX_lastChannel = ADC_MUX_NULL_CHANNEL;


/*******************************************************************************
* Function Name: ADC_MUX_Start
********************************************************************************
* Summary:
...
void ADC_MUX_Start(void) 
{
    ...
    for(chan = 0u; chan < ADC_MUX_CHANNELS ; chan++)
    {
    ...
    ADC_MUX_lastChannel = ADC_MUX_NULL_CHANNEL;
}
...
/*******************************************************************************
* Function Name: ADC_MUX_FastSelect
********************************************************************************
* Summary:
...
void ADC_MUX_FastSelect(uint8 channel) 
{
    ...
    if( ADC_MUX_lastChannel != ADC_MUX_NULL_CHANNEL)
    {
        ADC_MUX_Disconnect(ADC_MUX_lastChannel);
    }
...
#if (ADC_MUX_MUXTYPE == ADC_MUX_MUX_DIFF)
#if (!ADC_MUX_ATMOSTONE)
/*******************************************************************************
...
#if (ADC_MUX_ATMOSTONE)
/*******************************************************************************
* Function Name: ADC_MUX_DisconnectAll
********************************************************************************
* Summary:
