...
CD /D "C:\Keil\UV4"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
IF NOT EXIST "C:\Users\maxwell18\Desktop\Capstone work\BBBuild\Erebus_Sensor.cydsn\Erebus_Sensor.svd" rem "C:\Users\maxwell18\Desktop\Capstone work\BBBuild\Erebus_Sensor.cydsn\Erebus_Sensor.sfr"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
