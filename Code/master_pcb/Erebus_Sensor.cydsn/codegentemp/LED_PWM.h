...
#define LED_PWM_INIT_COMPARE_VALUE2      127u
#define LED_PWM_INIT_INTERRUPTS_MODE     (uint8)(((uint8)(0u << LED_PWM_STATUS_TC_INT_EN_MASK_SHIFT)) | \
                                                  (uint8)((uint8)(0u << LED_PWM_STATUS_CMP2_INT_EN_MASK_SHIFT)) | \
                                                  (uint8)((uint8)(0u << LED_PWM_STATUS_CMP1_INT_EN_MASK_SHIFT )) | \
                                                  (uint8)((uint8)(0u << LED_PWM_STATUS_KILL_INT_EN_MASK_SHIFT )))
#define LED_PWM_DEFAULT_COMPARE2_MODE    (uint8)((uint8)3u << LED_PWM_CTRL_CMPMODE2_SHIFT)
...
******************************** */
    ...
    ***********************************/
    ...
    #define LED_PWM_CTRL_CMPMODE1_SHIFT    0x04u  /* As defined by Register map as MODE_CFG bits in CFG2*/
    
    #define LED_PWM_CTRL_DEAD_TIME_SHIFT   0x06u   /* As defined by Register map */

    /* Fixed Function Block Only CFG register bit definitions */
    #define LED_PWM_CFG0_MODE              0x02u   /*  Set to compare mode */
    
    /* #define LED_PWM_CFG0_ENABLE            0x01u */  /* Enable the block to run */
    #define LED_PWM_CFG0_DB                0x20u   /* As defined by Register map as DB bit in CFG0 */
    ...
    #define LED_PWM_STATUS_TC_SHIFT            0x07u   /* As defined by Register map as TC in SR0 */
    #define LED_PWM_STATUS_CMP1_SHIFT          0x06u   /* As defined by the Register map as CAP_CMP in SR0 */
    ...
    #define LED_PWM_RT1_MASK              (uint8)((uint8)0x03u << LED_PWM_RT1_SHIFT)/* Sync TC and CMP bit masks */
    #define LED_PWM_SYNC                  (uint8)((uint8)0x03u << LED_PWM_RT1_SHIFT)
    #define LED_PWM_SYNCDSI_SHIFT         0x00u
    #define LED_PWM_SYNCDSI_MASK          (uint8)((uint8)0x0Fu << LED_PWM_SYNCDSI_SHIFT) /* Sync all DSI inputs */
    #define LED_PWM_SYNCDSI_EN            (uint8)((uint8)0x0Fu << LED_PWM_SYNCDSI_SHIFT) /* Sync all DSI inputs */
