...
CD /D "C:\Keil\UV4"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
IF NOT EXIST "C:\Users\Win7_VM\Documents\PSoC Creator\Erebus_Sensor\Erebus_Sensor.cydsn\EEPROM_Design01.cydsn\EEPROM_Design01.svd" rem "C:\Users\Win7_VM\Documents\PSoC Creator\Erebus_Sensor\Erebus_Sensor.cydsn\EEPROM_Design01.cydsn\EEPROM_Design01.sfr"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
