...
***************************************/
    ...
    #endif /* End USBUART_MIDI_EXT_MODE >= USBUART_TWO_EXT_INTRF */
#endif /* End USBUART_MIDI_EXT_MODE >= USBUART_ONE_EXT_INTRF */
...
void USBUART_MIDI_EP_Init(void) 
{
    ...
    *******************************************************************************/
    void USBUART_MIDI_OUT_EP_Service(void) 
    {
            ...
            uint8 outLength;
            uint8 outPointer;
        #endif /* End USBUART_MIDI_OUT_BUFF_SIZE >=256 */
...
#endif  /* End (USBUART_ENABLE_MIDI_API != 0u) */
...
#endif  /* End defined(USBUART_ENABLE_MIDI_STREAMING) */
