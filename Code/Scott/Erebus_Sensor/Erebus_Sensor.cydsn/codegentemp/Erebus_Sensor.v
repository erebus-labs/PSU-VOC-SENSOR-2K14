...
module top ;
	...
	wire [0:0] tmpOE__V_bus_net;
	wire [0:0] tmpIO_0__V_bus_net;
	wire [0:0] tmpINTERRUPT_0__V_bus_net;
	electrical [0:0] tmpSIOVREF__V_bus_net;
	...
	cy_psoc3_pins_v1_10
		...
		V_bus
		 (.oe(tmpOE__V_bus_net),
		  .y({1'b0}),
		  .fb({Net_204}),
		  .io({tmpIO_0__V_bus_net[0:0]}),
		  .siovref(tmpSIOVREF__V_bus_net),
		  .interrupt({tmpINTERRUPT_0__V_bus_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__V_bus_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
