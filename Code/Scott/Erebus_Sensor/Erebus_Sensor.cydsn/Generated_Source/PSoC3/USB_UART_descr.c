...
* Device Descriptors
*********************************************************************/
const uint8 CYCODE USB_UART_DEVICE0_DESCR[18u] = {
...
* Config Descriptor  
*********************************************************************/
const uint8 CYCODE USB_UART_DEVICE0_CONFIGURATION0_DESCR[67u] = {
...
*********************************************************************/
const uint8 CYCODE USB_UART_STRING_DESCRIPTORS[69u] = {
/*********************************************************************
...
/*********************************************************************
* String Descriptor: "Erebus Labs"
*********************************************************************/
/* Descriptor Length                       */ 0x18u,
/* DescriptorType: STRING                  */ 0x03u,
 (uint8)'E', 0u,(uint8)'r', 0u,(uint8)'e', 0u,(uint8)'b', 0u,(uint8)'u', 0u,
 (uint8)'s', 0u,(uint8)' ', 0u,(uint8)'L', 0u,(uint8)'a', 0u,(uint8)'b', 0u,
 (uint8)'s', 0u,
/*********************************************************************
* String Descriptor: "STEM Sensor Rev 0.1"
*********************************************************************/
/* Descriptor Length                       */ 0x28u,
/* DescriptorType: STRING                  */ 0x03u,
 (uint8)'S', 0u,(uint8)'T', 0u,(uint8)'E', 0u,(uint8)'M', 0u,(uint8)' ', 0u,
 (uint8)'S', 0u,(uint8)'e', 0u,(uint8)'n', 0u,(uint8)'s', 0u,(uint8)'o', 0u,
 (uint8)'r', 0u,(uint8)' ', 0u,(uint8)'R', 0u,(uint8)'e', 0u,(uint8)'v', 0u,
...
*********************************************************************/
const uint8 CYCODE USB_UART_SN_STRING_DESCRIPTOR[2] = {
...
*********************************************************************/
const T_USB_UART_EP_SETTINGS_BLOCK CYCODE USB_UART_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE[3u] = {
...
const uint8 CYCODE USB_UART_DEVICE0_CONFIGURATION0_INTERFACE_CLASS[2u] = {
0x02u, 0x0Au
};
/*********************************************************************
...
*********************************************************************/
const T_USB_UART_LUT CYCODE USB_UART_DEVICE0_CONFIGURATION0_TABLE[5u] = {
    {0x01u,     &USB_UART_DEVICE0_CONFIGURATION0_DESCR},
    {0x03u,     &USB_UART_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE},
    {0x00u,    NULL},
    {0x00u,    NULL},
    {0x00u,     &USB_UART_DEVICE0_CONFIGURATION0_INTERFACE_CLASS}
};
/*********************************************************************
* Device Dispatch Table -- Points to the Device Descriptor and each of
*                          and Configuration Tables for this Device 
*********************************************************************/
const T_USB_UART_LUT CYCODE USB_UART_DEVICE0_TABLE[2u] = {
    {0x01u,     &USB_UART_DEVICE0_DESCR},
    {0x01u,     &USB_UART_DEVICE0_CONFIGURATION0_TABLE}
};
/*********************************************************************
* Device Table -- Indexed by the device number.
*********************************************************************/
const T_USB_UART_LUT CYCODE USB_UART_TABLE[1u] = {
    {0x01u,     &USB_UART_DEVICE0_TABLE}
};
    ...
    *  USB_UART_GET_EXTENDED_CONFIG_DESCRIPTOR becomes the bRequest value
    *  in a host vendor device/class request
    ******************************************************************************/

    const uint8 CYCODE USB_UART_MSOS_DESCRIPTOR[USB_UART_MSOS_DESCRIPTOR_LENGTH] = {
    /* Descriptor Length                       */   0x12u,
    /* DescriptorType: STRING                  */   0x03u,
    /* qwSignature - "MSFT100"                 */   (uint8)'M', 0u, (uint8)'S', 0u, (uint8)'F', 0u, (uint8)'T', 0u,
                                                    (uint8)'1', 0u, (uint8)'0', 0u, (uint8)'0', 0u,
    /* bMS_VendorCode:                         */   USB_UART_GET_EXTENDED_CONFIG_DESCRIPTOR,
    /* bPad                                    */   0x00u
    };

    /* Extended Configuration Descriptor */

    const uint8 CYCODE USB_UART_MSOS_CONFIGURATION_DESCR[USB_UART_MSOS_CONF_DESCR_LENGTH] = {
...
/* DIE ID string descriptor for 8 bytes ID */
    ...
    uint8 USB_UART_idSerialNumberStringDescriptor[USB_UART_IDSN_DESCR_LENGTH];
