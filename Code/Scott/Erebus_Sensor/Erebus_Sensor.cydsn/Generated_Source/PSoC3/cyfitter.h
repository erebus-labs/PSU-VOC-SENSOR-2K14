...
/* USBUART_1_bus_reset */
#define USBUART_1_bus_reset__ES2_PATCH 0u
#define USBUART_1_bus_reset__INTC_CLR_EN_REG CYREG_INTC_CLR_EN2
#define USBUART_1_bus_reset__INTC_CLR_PD_REG CYREG_INTC_CLR_PD2
#define USBUART_1_bus_reset__INTC_MASK 0x80u
#define USBUART_1_bus_reset__INTC_NUMBER 23u
#define USBUART_1_bus_reset__INTC_PRIOR_NUM 7u
#define USBUART_1_bus_reset__INTC_PRIOR_REG CYREG_INTC_PRIOR23
#define USBUART_1_bus_reset__INTC_SET_EN_REG CYREG_INTC_SET_EN2
#define USBUART_1_bus_reset__INTC_SET_PD_REG CYREG_INTC_SET_PD2
#define USBUART_1_bus_reset__INTC_VECT (CYREG_INTC_VECT_MBASE+0x2Eu)

/* USBUART_1_arb_int */
#define USBUART_1_arb_int__ES2_PATCH 0u
#define USBUART_1_arb_int__INTC_CLR_EN_REG CYREG_INTC_CLR_EN2
#define USBUART_1_arb_int__INTC_CLR_PD_REG CYREG_INTC_CLR_PD2
#define USBUART_1_arb_int__INTC_MASK 0x40u
#define USBUART_1_arb_int__INTC_NUMBER 22u
#define USBUART_1_arb_int__INTC_PRIOR_NUM 7u
#define USBUART_1_arb_int__INTC_PRIOR_REG CYREG_INTC_PRIOR22
#define USBUART_1_arb_int__INTC_SET_EN_REG CYREG_INTC_SET_EN2
#define USBUART_1_arb_int__INTC_SET_PD_REG CYREG_INTC_SET_PD2
#define USBUART_1_arb_int__INTC_VECT (CYREG_INTC_VECT_MBASE+0x2Cu)

/* USBUART_1_sof_int */
#define USBUART_1_sof_int__ES2_PATCH 0u
#define USBUART_1_sof_int__INTC_CLR_EN_REG CYREG_INTC_CLR_EN2
#define USBUART_1_sof_int__INTC_CLR_PD_REG CYREG_INTC_CLR_PD2
...
#define USBUART_1_sof_int__INTC_PRIOR_REG CYREG_INTC_PRIOR21
#define USBUART_1_sof_int__INTC_SET_EN_REG CYREG_INTC_SET_EN2
#define USBUART_1_sof_int__INTC_SET_PD_REG CYREG_INTC_SET_PD2
#define USBUART_1_sof_int__INTC_VECT (CYREG_INTC_VECT_MBASE+0x2Au)

/* USBUART_1_Vbus_ps */
#define USBUART_1_Vbus_ps_sts_sts_reg__0__MASK 0x01u
#define USBUART_1_Vbus_ps_sts_sts_reg__0__POS 0
#define USBUART_1_Vbus_ps_sts_sts_reg__16BIT_STATUS_AUX_CTL_REG CYREG_B0_UDB02_03_ACTL
#define USBUART_1_Vbus_ps_sts_sts_reg__16BIT_STATUS_REG CYREG_B0_UDB02_03_ST
#define USBUART_1_Vbus_ps_sts_sts_reg__MASK 0x01u
#define USBUART_1_Vbus_ps_sts_sts_reg__MASK_REG CYREG_B0_UDB02_MSK
#define USBUART_1_Vbus_ps_sts_sts_reg__STATUS_AUX_CTL_REG CYREG_B0_UDB02_ACTL
#define USBUART_1_Vbus_ps_sts_sts_reg__STATUS_REG CYREG_B0_UDB02_ST

/* USBUART_1_dp_int */
#define USBUART_1_dp_int__ES2_PATCH 0u
#define USBUART_1_dp_int__INTC_CLR_EN_REG CYREG_INTC_CLR_EN1
#define USBUART_1_dp_int__INTC_CLR_PD_REG CYREG_INTC_CLR_PD1
#define USBUART_1_dp_int__INTC_MASK 0x10u
#define USBUART_1_dp_int__INTC_NUMBER 12u
#define USBUART_1_dp_int__INTC_PRIOR_NUM 7u
#define USBUART_1_dp_int__INTC_PRIOR_REG CYREG_INTC_PRIOR12
#define USBUART_1_dp_int__INTC_SET_EN_REG CYREG_INTC_SET_EN1
#define USBUART_1_dp_int__INTC_SET_PD_REG CYREG_INTC_SET_PD1
#define USBUART_1_dp_int__INTC_VECT (CYREG_INTC_VECT_MBASE+0x18u)
...
/* USBUART_1_ep_0 */
#define USBUART_1_ep_0__ES2_PATCH 0u
#define USBUART_1_ep_0__INTC_CLR_EN_REG CYREG_INTC_CLR_EN3
#define USBUART_1_ep_0__INTC_CLR_PD_REG CYREG_INTC_CLR_PD3
#define USBUART_1_ep_0__INTC_MASK 0x01u
#define USBUART_1_ep_0__INTC_NUMBER 24u
#define USBUART_1_ep_0__INTC_PRIOR_NUM 7u
#define USBUART_1_ep_0__INTC_PRIOR_REG CYREG_INTC_PRIOR24
#define USBUART_1_ep_0__INTC_SET_EN_REG CYREG_INTC_SET_EN3
#define USBUART_1_ep_0__INTC_SET_PD_REG CYREG_INTC_SET_PD3
#define USBUART_1_ep_0__INTC_VECT (CYREG_INTC_VECT_MBASE+0x30u)

/* USBUART_1_ep_1 */
#define USBUART_1_ep_1__ES2_PATCH 0u
#define USBUART_1_ep_1__INTC_CLR_EN_REG CYREG_INTC_CLR_EN0
#define USBUART_1_ep_1__INTC_CLR_PD_REG CYREG_INTC_CLR_PD0
#define USBUART_1_ep_1__INTC_MASK 0x04u
#define USBUART_1_ep_1__INTC_NUMBER 2u
#define USBUART_1_ep_1__INTC_PRIOR_NUM 7u
#define USBUART_1_ep_1__INTC_PRIOR_REG CYREG_INTC_PRIOR2
#define USBUART_1_ep_1__INTC_SET_EN_REG CYREG_INTC_SET_EN0
#define USBUART_1_ep_1__INTC_SET_PD_REG CYREG_INTC_SET_PD0
#define USBUART_1_ep_1__INTC_VECT (CYREG_INTC_VECT_MBASE+0x04u)

/* USBUART_1_ep_2 */
#define USBUART_1_ep_2__ES2_PATCH 0u
#define USBUART_1_ep_2__INTC_CLR_EN_REG CYREG_INTC_CLR_EN0
#define USBUART_1_ep_2__INTC_CLR_PD_REG CYREG_INTC_CLR_PD0
#define USBUART_1_ep_2__INTC_MASK 0x08u
#define USBUART_1_ep_2__INTC_NUMBER 3u
#define USBUART_1_ep_2__INTC_PRIOR_NUM 7u
#define USBUART_1_ep_2__INTC_PRIOR_REG CYREG_INTC_PRIOR3
#define USBUART_1_ep_2__INTC_SET_EN_REG CYREG_INTC_SET_EN0
#define USBUART_1_ep_2__INTC_SET_PD_REG CYREG_INTC_SET_PD0
#define USBUART_1_ep_2__INTC_VECT (CYREG_INTC_VECT_MBASE+0x06u)

/* USBUART_1_ep_3 */
#define USBUART_1_ep_3__ES2_PATCH 0u
#define USBUART_1_ep_3__INTC_CLR_EN_REG CYREG_INTC_CLR_EN0
#define USBUART_1_ep_3__INTC_CLR_PD_REG CYREG_INTC_CLR_PD0
#define USBUART_1_ep_3__INTC_MASK 0x10u
#define USBUART_1_ep_3__INTC_NUMBER 4u
#define USBUART_1_ep_3__INTC_PRIOR_NUM 7u
#define USBUART_1_ep_3__INTC_PRIOR_REG CYREG_INTC_PRIOR4
#define USBUART_1_ep_3__INTC_SET_EN_REG CYREG_INTC_SET_EN0
#define USBUART_1_ep_3__INTC_SET_PD_REG CYREG_INTC_SET_PD0
#define USBUART_1_ep_3__INTC_VECT (CYREG_INTC_VECT_MBASE+0x08u)
...
/* USB_DIS_ISR */
#define USB_DIS_ISR__ES2_PATCH 0u
#define USB_DIS_ISR__INTC_CLR_EN_REG CYREG_INTC_CLR_EN0
#define USB_DIS_ISR__INTC_CLR_PD_REG CYREG_INTC_CLR_PD0
#define USB_DIS_ISR__INTC_MASK 0x01u
#define USB_DIS_ISR__INTC_NUMBER 0u
#define USB_DIS_ISR__INTC_PRIOR_NUM 7u
#define USB_DIS_ISR__INTC_PRIOR_REG CYREG_INTC_PRIOR0
#define USB_DIS_ISR__INTC_SET_EN_REG CYREG_INTC_SET_EN0
#define USB_DIS_ISR__INTC_SET_PD_REG CYREG_INTC_SET_PD0
#define USB_DIS_ISR__INTC_VECT (CYREG_INTC_VECT_MBASE+0x00u)

/* USB_EN_ISR */
#define USB_EN_ISR__ES2_PATCH 0u
#define USB_EN_ISR__INTC_CLR_EN_REG CYREG_INTC_CLR_EN0
#define USB_EN_ISR__INTC_CLR_PD_REG CYREG_INTC_CLR_PD0
#define USB_EN_ISR__INTC_MASK 0x02u
#define USB_EN_ISR__INTC_NUMBER 1u
#define USB_EN_ISR__INTC_PRIOR_NUM 7u
#define USB_EN_ISR__INTC_PRIOR_REG CYREG_INTC_PRIOR1
#define USB_EN_ISR__INTC_SET_EN_REG CYREG_INTC_SET_EN0
#define USB_EN_ISR__INTC_SET_PD_REG CYREG_INTC_SET_PD0
#define USB_EN_ISR__INTC_VECT (CYREG_INTC_VECT_MBASE+0x02u)

/* V_bus */
#define V_bus__0__MASK 0x02u
#define V_bus__0__PC CYREG_PRT0_PC1
#define V_bus__0__PORT 0u
#define V_bus__0__SHIFT 1
#define V_bus__AG CYREG_PRT0_AG
#define V_bus__AMUX CYREG_PRT0_AMUX
#define V_bus__BIE CYREG_PRT0_BIE
#define V_bus__BIT_MASK CYREG_PRT0_BIT_MASK
#define V_bus__BYP CYREG_PRT0_BYP
#define V_bus__CTL CYREG_PRT0_CTL
#define V_bus__DM0 CYREG_PRT0_DM0
#define V_bus__DM1 CYREG_PRT0_DM1
#define V_bus__DM2 CYREG_PRT0_DM2
#define V_bus__DR CYREG_PRT0_DR
#define V_bus__INP_DIS CYREG_PRT0_INP_DIS
#define V_bus__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define V_bus__LCD_EN CYREG_PRT0_LCD_EN
#define V_bus__MASK 0x02u
#define V_bus__PORT 0u
#define V_bus__PRT CYREG_PRT0_PRT
#define V_bus__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define V_bus__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define V_bus__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define V_bus__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define V_bus__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define V_bus__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define V_bus__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define V_bus__PS CYREG_PRT0_PS
#define V_bus__SHIFT 1
#define V_bus__SLW CYREG_PRT0_SLW
