...
CD /D "C:\Keil\UV4"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
IF NOT EXIST "C:\Users\bryan_000\Documents\GitHub\frack-n-sensor\Code\Bryan yo\Erebus_Sensor.cydsn\Erebus_Sensor.svd" rem "C:\Users\bryan_000\Documents\GitHub\frack-n-sensor\Code\Bryan yo\Erebus_Sensor.cydsn\Erebus_Sensor.sfr"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
