...
*   or TimerISR_StartEx will override any effect this method would 
*   have had. This method should only be called after TimerISR_Start or 
...
uint8 TimerISR_GetState(void) 
{
    ...
    return ((*TimerISR_INTC_SET_EN & (uint8)TimerISR__INTC_MASK) != 0u) ? 1u:0u;
}
