...
uint8 Flash_Blink_TI_initVar = 0u;


/*******************************************************************************
* Function Name: Flash_Blink_TI_Init
********************************************************************************
*
* Summary:
...
void Flash_Blink_TI_Init(void) 
{
    ...
    Flash_Blink_TI_WritePeriod(Flash_Blink_TI_INIT_PERIOD);
    Flash_Blink_TI_WriteCounter(Flash_Blink_TI_INIT_PERIOD);

    #if (Flash_Blink_TI_UsingHWCaptureCounter)/* Capture counter is enabled */
        ...
        Flash_Blink_TI_ClearFIFO();
    #endif /* Configure additional features of UDB implementation */

    Flash_Blink_TI_SetInterruptMode(Flash_Blink_TI_INIT_INTERRUPT_MODE);
}


/*******************************************************************************
* Function Name: Flash_Blink_TI_Enable
********************************************************************************
*
* Summary:
*  Enable the Timer
...
void Flash_Blink_TI_Enable(void) 
{
    ...
    #if (!Flash_Blink_TI_ControlRegRemoved || Flash_Blink_TI_UsingFixedFunction)
        Flash_Blink_TI_CONTROL |= Flash_Blink_TI_CTRL_ENABLE;
...
/*******************************************************************************
* Function Name: Flash_Blink_TI_Start
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  Flash_Blink_TI_initVar: Is modified when this function is called for the
*   first time. Is used to ensure that initialization happens only once.
*
*******************************************************************************/
void Flash_Blink_TI_Start(void) 
{
    if(Flash_Blink_TI_initVar == 0u)
    {
        Flash_Blink_TI_Init();

        Flash_Blink_TI_initVar = 1u;   /* Clear this bit for Initialization */
    }
...
/*******************************************************************************
* Function Name: Flash_Blink_TI_Stop
********************************************************************************
*
* Summary:
...
void Flash_Blink_TI_Stop(void) 
{
    /* Disable Timer */
    #if(!Flash_Blink_TI_ControlRegRemoved || Flash_Blink_TI_UsingFixedFunction)
        Flash_Blink_TI_CONTROL &= ((uint8)(~Flash_Blink_TI_CTRL_ENABLE));
    #endif /* Remove assignment if control register is removed */
...
/*******************************************************************************
* Function Name: Flash_Blink_TI_SetInterruptMode
********************************************************************************
*
* Summary:
...
{
    Flash_Blink_TI_STATUS_MASK = interruptMode;
}


/*******************************************************************************
* Function Name: Flash_Blink_TI_SoftwareCapture
********************************************************************************
*
* Summary:
...
void Flash_Blink_TI_SoftwareCapture(void) 
{
    ...
    (void)Flash_Blink_TI_COUNTER_LSB;
    /* Capture Data is now in the FIFO */
}


/*******************************************************************************
* Function Name: Flash_Blink_TI_ReadStatusRegister
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: Flash_Blink_TI_ReadControlRegister
********************************************************************************
*
* Summary:
...
{
    return ((uint8)Flash_Blink_TI_CONTROL);
}


/*******************************************************************************
* Function Name: Flash_Blink_TI_WriteControlRegister
********************************************************************************
*
* Summary:
...
{
    Flash_Blink_TI_CONTROL = control;
}
#endif /* Remove API if control register is removed */


/*******************************************************************************
* Function Name: Flash_Blink_TI_ReadPeriod
********************************************************************************
*
* Summary:
...
uint16 Flash_Blink_TI_ReadPeriod(void) 
{
   ...
   #else
       return (CY_GET_REG16(Flash_Blink_TI_PERIOD_LSB_PTR));
   #endif /* (Flash_Blink_TI_UsingFixedFunction) */
}


/*******************************************************************************
* Function Name: Flash_Blink_TI_WritePeriod
********************************************************************************
*
* Summary:
...
void Flash_Blink_TI_WritePeriod(uint16 period) 
{
    ...
    #else
        CY_SET_REG16(Flash_Blink_TI_PERIOD_LSB_PTR, period);
    #endif /*Write Period value with appropriate resolution suffix depending on UDB or fixed function implementation */
}


/*******************************************************************************
* Function Name: Flash_Blink_TI_ReadCapture
********************************************************************************
*
* Summary:
...
uint16 Flash_Blink_TI_ReadCapture(void) 
{
   ...
   #else
       return (CY_GET_REG16(Flash_Blink_TI_CAPTURE_LSB_PTR));
   #endif /* (Flash_Blink_TI_UsingFixedFunction) */
}


/*******************************************************************************
* Function Name: Flash_Blink_TI_WriteCounter
********************************************************************************
*
* Summary:
                                   ...
                                   
{
    ...
    #else
        CY_SET_REG16(Flash_Blink_TI_COUNTER_LSB_PTR, counter);
    #endif /* Set Write Counter only for the UDB implementation (Write Counter not available in fixed function Timer */
}


/*******************************************************************************
* Function Name: Flash_Blink_TI_ReadCounter
********************************************************************************
*
* Summary:
...
#if(!Flash_Blink_TI_UsingFixedFunction) /* UDB Specific Functions */
...
/*******************************************************************************
* Function Name: Flash_Blink_TI_ClearFIFO
********************************************************************************
*
* Summary:
...
{
    while(0u != (Flash_Blink_TI_ReadStatusRegister() & Flash_Blink_TI_STATUS_FIFONEMP))
    {
        (void)Flash_Blink_TI_ReadCapture();
    }
}
