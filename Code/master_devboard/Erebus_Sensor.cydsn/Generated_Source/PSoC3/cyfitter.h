...
#define ModifyCollection_IRQ__INTC_CLR_EN_REG CYREG_INTC_CLR_EN1
#define ModifyCollection_IRQ__INTC_CLR_PD_REG CYREG_INTC_CLR_PD1
#define ModifyCollection_IRQ__INTC_MASK 0x08u
#define ModifyCollection_IRQ__INTC_NUMBER 11u
#define ModifyCollection_IRQ__INTC_PRIOR_NUM 7u
#define ModifyCollection_IRQ__INTC_PRIOR_REG CYREG_INTC_PRIOR11
#define ModifyCollection_IRQ__INTC_SET_EN_REG CYREG_INTC_SET_EN1
#define ModifyCollection_IRQ__INTC_SET_PD_REG CYREG_INTC_SET_PD1
#define ModifyCollection_IRQ__INTC_VECT (CYREG_INTC_VECT_MBASE+0x16u)

/* ModifyCollection_B */
#define ModifyCollection_B__0__MASK 0x20u
#define ModifyCollection_B__0__PC CYREG_PRT12_PC5
#define ModifyCollection_B__0__PORT 12u
#define ModifyCollection_B__0__SHIFT 5
#define ModifyCollection_B__1__MASK 0x40u
#define ModifyCollection_B__1__PC CYREG_PRT12_PC6
#define ModifyCollection_B__1__PORT 12u
#define ModifyCollection_B__1__SHIFT 6
#define ModifyCollection_B__AG CYREG_PRT12_AG
#define ModifyCollection_B__BIE CYREG_PRT12_BIE
#define ModifyCollection_B__BIT_MASK CYREG_PRT12_BIT_MASK
#define ModifyCollection_B__BYP CYREG_PRT12_BYP
#define ModifyCollection_B__DM0 CYREG_PRT12_DM0
#define ModifyCollection_B__DM1 CYREG_PRT12_DM1
#define ModifyCollection_B__DM2 CYREG_PRT12_DM2
#define ModifyCollection_B__DR CYREG_PRT12_DR
#define ModifyCollection_B__INP_DIS CYREG_PRT12_INP_DIS
#define ModifyCollection_B__INTSTAT CYREG_PICU12_INTSTAT
#define ModifyCollection_B__MASK 0x60u
#define ModifyCollection_B__PORT 12u
#define ModifyCollection_B__PRT CYREG_PRT12_PRT
#define ModifyCollection_B__PRTDSI__DBL_SYNC_IN CYREG_PRT12_DBL_SYNC_IN
#define ModifyCollection_B__PRTDSI__OE_SEL0 CYREG_PRT12_OE_SEL0
#define ModifyCollection_B__PRTDSI__OE_SEL1 CYREG_PRT12_OE_SEL1
#define ModifyCollection_B__PRTDSI__OUT_SEL0 CYREG_PRT12_OUT_SEL0
#define ModifyCollection_B__PRTDSI__OUT_SEL1 CYREG_PRT12_OUT_SEL1
#define ModifyCollection_B__PRTDSI__SYNC_OUT CYREG_PRT12_SYNC_OUT
#define ModifyCollection_B__PS CYREG_PRT12_PS
#define ModifyCollection_B__SHIFT 5
#define ModifyCollection_B__SIO_CFG CYREG_PRT12_SIO_CFG
#define ModifyCollection_B__SIO_DIFF CYREG_PRT12_SIO_DIFF
#define ModifyCollection_B__SIO_HYST_EN CYREG_PRT12_SIO_HYST_EN
#define ModifyCollection_B__SIO_REG_HIFREQ CYREG_PRT12_SIO_REG_HIFREQ
#define ModifyCollection_B__SLW CYREG_PRT12_SLW
#define ModifyCollection_B__SNAP CYREG_PICU12_SNAP
...
/* LED_PWM_PWMUDB */
#define LED_PWM_PWMUDB_genblk1_ctrlreg__16BIT_CONTROL_AUX_CTL_REG CYREG_B1_UDB07_08_ACTL
#define LED_PWM_PWMUDB_genblk1_ctrlreg__16BIT_CONTROL_CONTROL_REG CYREG_B1_UDB07_08_CTL
#define LED_PWM_PWMUDB_genblk1_ctrlreg__16BIT_CONTROL_COUNT_REG CYREG_B1_UDB07_08_CTL
#define LED_PWM_PWMUDB_genblk1_ctrlreg__16BIT_COUNT_CONTROL_REG CYREG_B1_UDB07_08_CTL
#define LED_PWM_PWMUDB_genblk1_ctrlreg__16BIT_COUNT_COUNT_REG CYREG_B1_UDB07_08_CTL
#define LED_PWM_PWMUDB_genblk1_ctrlreg__16BIT_MASK_MASK_REG CYREG_B1_UDB07_08_MSK
#define LED_PWM_PWMUDB_genblk1_ctrlreg__16BIT_MASK_PERIOD_REG CYREG_B1_UDB07_08_MSK
#define LED_PWM_PWMUDB_genblk1_ctrlreg__16BIT_PERIOD_MASK_REG CYREG_B1_UDB07_08_MSK
#define LED_PWM_PWMUDB_genblk1_ctrlreg__16BIT_PERIOD_PERIOD_REG CYREG_B1_UDB07_08_MSK
#define LED_PWM_PWMUDB_genblk1_ctrlreg__7__MASK 0x80u
#define LED_PWM_PWMUDB_genblk1_ctrlreg__7__POS 7
#define LED_PWM_PWMUDB_genblk1_ctrlreg__CONTROL_AUX_CTL_REG CYREG_B1_UDB07_ACTL
#define LED_PWM_PWMUDB_genblk1_ctrlreg__CONTROL_REG CYREG_B1_UDB07_CTL
#define LED_PWM_PWMUDB_genblk1_ctrlreg__CONTROL_ST_REG CYREG_B1_UDB07_ST_CTL
#define LED_PWM_PWMUDB_genblk1_ctrlreg__COUNT_REG CYREG_B1_UDB07_CTL
#define LED_PWM_PWMUDB_genblk1_ctrlreg__COUNT_ST_REG CYREG_B1_UDB07_ST_CTL
#define LED_PWM_PWMUDB_genblk1_ctrlreg__MASK 0x80u
#define LED_PWM_PWMUDB_genblk1_ctrlreg__MASK_CTL_AUX_CTL_REG CYREG_B1_UDB07_MSK_ACTL
#define LED_PWM_PWMUDB_genblk1_ctrlreg__PERIOD_REG CYREG_B1_UDB07_MSK
#define LED_PWM_PWMUDB_genblk1_ctrlreg__PER_CTL_AUX_CTL_REG CYREG_B1_UDB07_MSK_ACTL
#define LED_PWM_PWMUDB_sP8_pwmdp_u0__16BIT_A0_REG CYREG_B1_UDB05_06_A0
#define LED_PWM_PWMUDB_sP8_pwmdp_u0__16BIT_A1_REG CYREG_B1_UDB05_06_A1
#define LED_PWM_PWMUDB_sP8_pwmdp_u0__16BIT_D0_REG CYREG_B1_UDB05_06_D0
#define LED_PWM_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG CYREG_B1_UDB05_06_D1
#define LED_PWM_PWMUDB_sP8_pwmdp_u0__16BIT_DP_AUX_CTL_REG CYREG_B1_UDB05_06_ACTL
#define LED_PWM_PWMUDB_sP8_pwmdp_u0__16BIT_F0_REG CYREG_B1_UDB05_06_F0
#define LED_PWM_PWMUDB_sP8_pwmdp_u0__16BIT_F1_REG CYREG_B1_UDB05_06_F1
#define LED_PWM_PWMUDB_sP8_pwmdp_u0__A0_A1_REG CYREG_B1_UDB05_A0_A1
#define LED_PWM_PWMUDB_sP8_pwmdp_u0__A0_REG CYREG_B1_UDB05_A0
#define LED_PWM_PWMUDB_sP8_pwmdp_u0__A1_REG CYREG_B1_UDB05_A1
#define LED_PWM_PWMUDB_sP8_pwmdp_u0__D0_D1_REG CYREG_B1_UDB05_D0_D1
#define LED_PWM_PWMUDB_sP8_pwmdp_u0__D0_REG CYREG_B1_UDB05_D0
#define LED_PWM_PWMUDB_sP8_pwmdp_u0__D1_REG CYREG_B1_UDB05_D1
#define LED_PWM_PWMUDB_sP8_pwmdp_u0__DP_AUX_CTL_REG CYREG_B1_UDB05_ACTL
#define LED_PWM_PWMUDB_sP8_pwmdp_u0__F0_F1_REG CYREG_B1_UDB05_F0_F1
#define LED_PWM_PWMUDB_sP8_pwmdp_u0__F0_REG CYREG_B1_UDB05_F0
#define LED_PWM_PWMUDB_sP8_pwmdp_u0__F1_REG CYREG_B1_UDB05_F1
#define LED_PWM_PWMUDB_sP8_pwmdp_u0__MSK_DP_AUX_CTL_REG CYREG_B1_UDB05_MSK_ACTL
#define LED_PWM_PWMUDB_sP8_pwmdp_u0__PER_DP_AUX_CTL_REG CYREG_B1_UDB05_MSK_ACTL

/* SOLID_LED_CTRL */
#define SOLID_LED_CTRL_Sync_ctrl_reg__0__MASK 0x01u
#define SOLID_LED_CTRL_Sync_ctrl_reg__0__POS 0
#define SOLID_LED_CTRL_Sync_ctrl_reg__16BIT_CONTROL_AUX_CTL_REG CYREG_B1_UDB05_06_ACTL
#define SOLID_LED_CTRL_Sync_ctrl_reg__16BIT_CONTROL_CONTROL_REG CYREG_B1_UDB05_06_CTL
#define SOLID_LED_CTRL_Sync_ctrl_reg__16BIT_CONTROL_COUNT_REG CYREG_B1_UDB05_06_CTL
#define SOLID_LED_CTRL_Sync_ctrl_reg__16BIT_COUNT_CONTROL_REG CYREG_B1_UDB05_06_CTL
#define SOLID_LED_CTRL_Sync_ctrl_reg__16BIT_COUNT_COUNT_REG CYREG_B1_UDB05_06_CTL
#define SOLID_LED_CTRL_Sync_ctrl_reg__16BIT_MASK_MASK_REG CYREG_B1_UDB05_06_MSK
#define SOLID_LED_CTRL_Sync_ctrl_reg__16BIT_MASK_PERIOD_REG CYREG_B1_UDB05_06_MSK
#define SOLID_LED_CTRL_Sync_ctrl_reg__16BIT_PERIOD_MASK_REG CYREG_B1_UDB05_06_MSK
#define SOLID_LED_CTRL_Sync_ctrl_reg__16BIT_PERIOD_PERIOD_REG CYREG_B1_UDB05_06_MSK
...
#define SOLID_LED_CTRL_Sync_ctrl_reg__CONTROL_AUX_CTL_REG CYREG_B1_UDB05_ACTL
#define SOLID_LED_CTRL_Sync_ctrl_reg__CONTROL_REG CYREG_B1_UDB05_CTL
#define SOLID_LED_CTRL_Sync_ctrl_reg__CONTROL_ST_REG CYREG_B1_UDB05_ST_CTL
#define SOLID_LED_CTRL_Sync_ctrl_reg__COUNT_REG CYREG_B1_UDB05_CTL
#define SOLID_LED_CTRL_Sync_ctrl_reg__COUNT_ST_REG CYREG_B1_UDB05_ST_CTL
#define SOLID_LED_CTRL_Sync_ctrl_reg__MASK 0x07u
#define SOLID_LED_CTRL_Sync_ctrl_reg__MASK_CTL_AUX_CTL_REG CYREG_B1_UDB05_MSK_ACTL
#define SOLID_LED_CTRL_Sync_ctrl_reg__PERIOD_REG CYREG_B1_UDB05_MSK
#define SOLID_LED_CTRL_Sync_ctrl_reg__PER_CTL_AUX_CTL_REG CYREG_B1_UDB05_MSK_ACTL
...
/* Batt_Monitor */
#define Batt_Monitor__0__MASK 0x40u
#define Batt_Monitor__0__PC CYREG_PRT6_PC6
#define Batt_Monitor__0__PORT 6u
#define Batt_Monitor__0__SHIFT 6
#define Batt_Monitor__AG CYREG_PRT6_AG
#define Batt_Monitor__AMUX CYREG_PRT6_AMUX
#define Batt_Monitor__BIE CYREG_PRT6_BIE
#define Batt_Monitor__BIT_MASK CYREG_PRT6_BIT_MASK
#define Batt_Monitor__BYP CYREG_PRT6_BYP
#define Batt_Monitor__CTL CYREG_PRT6_CTL
#define Batt_Monitor__DM0 CYREG_PRT6_DM0
#define Batt_Monitor__DM1 CYREG_PRT6_DM1
#define Batt_Monitor__DM2 CYREG_PRT6_DM2
#define Batt_Monitor__DR CYREG_PRT6_DR
#define Batt_Monitor__INP_DIS CYREG_PRT6_INP_DIS
#define Batt_Monitor__LCD_COM_SEG CYREG_PRT6_LCD_COM_SEG
#define Batt_Monitor__LCD_EN CYREG_PRT6_LCD_EN
#define Batt_Monitor__MASK 0x40u
#define Batt_Monitor__PORT 6u
#define Batt_Monitor__PRT CYREG_PRT6_PRT
#define Batt_Monitor__PRTDSI__CAPS_SEL CYREG_PRT6_CAPS_SEL
#define Batt_Monitor__PRTDSI__DBL_SYNC_IN CYREG_PRT6_DBL_SYNC_IN
#define Batt_Monitor__PRTDSI__OE_SEL0 CYREG_PRT6_OE_SEL0
#define Batt_Monitor__PRTDSI__OE_SEL1 CYREG_PRT6_OE_SEL1
#define Batt_Monitor__PRTDSI__OUT_SEL0 CYREG_PRT6_OUT_SEL0
#define Batt_Monitor__PRTDSI__OUT_SEL1 CYREG_PRT6_OUT_SEL1
#define Batt_Monitor__PRTDSI__SYNC_OUT CYREG_PRT6_SYNC_OUT
#define Batt_Monitor__PS CYREG_PRT6_PS
#define Batt_Monitor__SHIFT 6
#define Batt_Monitor__SLW CYREG_PRT6_SLW
...
#define PWM0_CTRL_Sync_ctrl_reg__16BIT_CONTROL_AUX_CTL_REG CYREG_B1_UDB04_05_ACTL
#define PWM0_CTRL_Sync_ctrl_reg__16BIT_CONTROL_CONTROL_REG CYREG_B1_UDB04_05_CTL
#define PWM0_CTRL_Sync_ctrl_reg__16BIT_CONTROL_COUNT_REG CYREG_B1_UDB04_05_CTL
#define PWM0_CTRL_Sync_ctrl_reg__16BIT_COUNT_CONTROL_REG CYREG_B1_UDB04_05_CTL
#define PWM0_CTRL_Sync_ctrl_reg__16BIT_COUNT_COUNT_REG CYREG_B1_UDB04_05_CTL
#define PWM0_CTRL_Sync_ctrl_reg__16BIT_MASK_MASK_REG CYREG_B1_UDB04_05_MSK
#define PWM0_CTRL_Sync_ctrl_reg__16BIT_MASK_PERIOD_REG CYREG_B1_UDB04_05_MSK
#define PWM0_CTRL_Sync_ctrl_reg__16BIT_PERIOD_MASK_REG CYREG_B1_UDB04_05_MSK
#define PWM0_CTRL_Sync_ctrl_reg__16BIT_PERIOD_PERIOD_REG CYREG_B1_UDB04_05_MSK
#define PWM0_CTRL_Sync_ctrl_reg__1__MASK 0x02u
#define PWM0_CTRL_Sync_ctrl_reg__1__POS 1
#define PWM0_CTRL_Sync_ctrl_reg__CONTROL_AUX_CTL_REG CYREG_B1_UDB04_ACTL
#define PWM0_CTRL_Sync_ctrl_reg__CONTROL_REG CYREG_B1_UDB04_CTL
#define PWM0_CTRL_Sync_ctrl_reg__CONTROL_ST_REG CYREG_B1_UDB04_ST_CTL
#define PWM0_CTRL_Sync_ctrl_reg__COUNT_REG CYREG_B1_UDB04_CTL
#define PWM0_CTRL_Sync_ctrl_reg__COUNT_ST_REG CYREG_B1_UDB04_ST_CTL
#define PWM0_CTRL_Sync_ctrl_reg__MASK 0x03u
#define PWM0_CTRL_Sync_ctrl_reg__MASK_CTL_AUX_CTL_REG CYREG_B1_UDB04_MSK_ACTL
#define PWM0_CTRL_Sync_ctrl_reg__PERIOD_REG CYREG_B1_UDB04_MSK
#define PWM0_CTRL_Sync_ctrl_reg__PER_CTL_AUX_CTL_REG CYREG_B1_UDB04_MSK_ACTL

/* PWM1_CTRL */
#define PWM1_CTRL_Sync_ctrl_reg__0__MASK 0x01u
#define PWM1_CTRL_Sync_ctrl_reg__0__POS 0
#define PWM1_CTRL_Sync_ctrl_reg__16BIT_CONTROL_AUX_CTL_REG CYREG_B1_UDB06_07_ACTL
#define PWM1_CTRL_Sync_ctrl_reg__16BIT_CONTROL_CONTROL_REG CYREG_B1_UDB06_07_CTL
#define PWM1_CTRL_Sync_ctrl_reg__16BIT_CONTROL_COUNT_REG CYREG_B1_UDB06_07_CTL
#define PWM1_CTRL_Sync_ctrl_reg__16BIT_COUNT_CONTROL_REG CYREG_B1_UDB06_07_CTL
#define PWM1_CTRL_Sync_ctrl_reg__16BIT_COUNT_COUNT_REG CYREG_B1_UDB06_07_CTL
#define PWM1_CTRL_Sync_ctrl_reg__16BIT_MASK_MASK_REG CYREG_B1_UDB06_07_MSK
#define PWM1_CTRL_Sync_ctrl_reg__16BIT_MASK_PERIOD_REG CYREG_B1_UDB06_07_MSK
#define PWM1_CTRL_Sync_ctrl_reg__16BIT_PERIOD_MASK_REG CYREG_B1_UDB06_07_MSK
#define PWM1_CTRL_Sync_ctrl_reg__16BIT_PERIOD_PERIOD_REG CYREG_B1_UDB06_07_MSK
#define PWM1_CTRL_Sync_ctrl_reg__1__MASK 0x02u
#define PWM1_CTRL_Sync_ctrl_reg__1__POS 1
#define PWM1_CTRL_Sync_ctrl_reg__CONTROL_AUX_CTL_REG CYREG_B1_UDB06_ACTL
#define PWM1_CTRL_Sync_ctrl_reg__CONTROL_REG CYREG_B1_UDB06_CTL
#define PWM1_CTRL_Sync_ctrl_reg__CONTROL_ST_REG CYREG_B1_UDB06_ST_CTL
#define PWM1_CTRL_Sync_ctrl_reg__COUNT_REG CYREG_B1_UDB06_CTL
#define PWM1_CTRL_Sync_ctrl_reg__COUNT_ST_REG CYREG_B1_UDB06_ST_CTL
#define PWM1_CTRL_Sync_ctrl_reg__MASK 0x03u
#define PWM1_CTRL_Sync_ctrl_reg__MASK_CTL_AUX_CTL_REG CYREG_B1_UDB06_MSK_ACTL
#define PWM1_CTRL_Sync_ctrl_reg__PERIOD_REG CYREG_B1_UDB06_MSK
#define PWM1_CTRL_Sync_ctrl_reg__PER_CTL_AUX_CTL_REG CYREG_B1_UDB06_MSK_ACTL
...
#define RGB_LED__0__PC CYREG_PRT3_PC5
#define RGB_LED__0__PORT 3u
#define RGB_LED__0__SHIFT 5
#define RGB_LED__1__MASK 0x40u
#define RGB_LED__1__PC CYREG_PRT3_PC6
#define RGB_LED__1__PORT 3u
#define RGB_LED__1__SHIFT 6
#define RGB_LED__2__MASK 0x80u
#define RGB_LED__2__PC CYREG_PRT3_PC7
#define RGB_LED__2__PORT 3u
#define RGB_LED__2__SHIFT 7
#define RGB_LED__AG CYREG_PRT3_AG
#define RGB_LED__AMUX CYREG_PRT3_AMUX
#define RGB_LED__BIE CYREG_PRT3_BIE
#define RGB_LED__BIT_MASK CYREG_PRT3_BIT_MASK
#define RGB_LED__BYP CYREG_PRT3_BYP
#define RGB_LED__CTL CYREG_PRT3_CTL
#define RGB_LED__DM0 CYREG_PRT3_DM0
#define RGB_LED__DM1 CYREG_PRT3_DM1
#define RGB_LED__DM2 CYREG_PRT3_DM2
#define RGB_LED__DR CYREG_PRT3_DR
#define RGB_LED__INP_DIS CYREG_PRT3_INP_DIS
#define RGB_LED__LCD_COM_SEG CYREG_PRT3_LCD_COM_SEG
#define RGB_LED__LCD_EN CYREG_PRT3_LCD_EN
#define RGB_LED__MASK 0xE0u
#define RGB_LED__PORT 3u
#define RGB_LED__PRT CYREG_PRT3_PRT
#define RGB_LED__PRTDSI__CAPS_SEL CYREG_PRT3_CAPS_SEL
#define RGB_LED__PRTDSI__DBL_SYNC_IN CYREG_PRT3_DBL_SYNC_IN
#define RGB_LED__PRTDSI__OE_SEL0 CYREG_PRT3_OE_SEL0
#define RGB_LED__PRTDSI__OE_SEL1 CYREG_PRT3_OE_SEL1
#define RGB_LED__PRTDSI__OUT_SEL0 CYREG_PRT3_OUT_SEL0
#define RGB_LED__PRTDSI__OUT_SEL1 CYREG_PRT3_OUT_SEL1
#define RGB_LED__PRTDSI__SYNC_OUT CYREG_PRT3_SYNC_OUT
#define RGB_LED__PS CYREG_PRT3_PS
#define RGB_LED__SHIFT 5
#define RGB_LED__SLW CYREG_PRT3_SLW
