...
CD /D "C:\Keil\UV4"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
IF NOT EXIST "C:\Users\maxwell18\Documents\PSoC Creator\Design02\Em_EEPROM_Example01.cydsn\Em_EEPROM_Example01.svd" rem "C:\Users\maxwell18\Documents\PSoC Creator\Design02\Em_EEPROM_Example01.cydsn\Em_EEPROM_Example01.sfr"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
